...
class FindRasterPonds(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config: Optional[dict[str, Any]] = None):
        ...
        param_out_filledraster = QgsProcessingParameterRasterDestination(
        ...
        # mark as advanced
        param_out_filledraster.setFlags(param_out_filledraster.flags() | QgsProcessingParameterDefinition.Flag.FlagAdvanced)
        self.addParameter(param_out_filledraster)

        param_out_depthraster = QgsProcessingParameterRasterDestination(
        ...
        param_out_depthraster.setFlags(param_out_depthraster.flags() | QgsProcessingParameterDefinition.Flag.FlagAdvanced)
        self.addParameter(param_out_depthraster)

        param_out_validraster = QgsProcessingParameterRasterDestination(
            "OUTPUT_POND_DEPTH_RASTER_VALID",
            "Output Pond Depth Raster (Valid)",
            optional=True,
            createByDefault=False  # Do not add to viewer by default
        )
        param_out_validraster.setFlags(param_out_validraster.flags() | QgsProcessingParameterDefinition.Flag.FlagAdvanced)
        self.addParameter(param_out_validraster)
    ...
    def processAlgorithm(
        ...
        # debug numpy raster output removed
